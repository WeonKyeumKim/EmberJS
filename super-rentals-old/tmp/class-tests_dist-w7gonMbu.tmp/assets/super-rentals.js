  ...
  var _default = Ember.Component.extend({
    ...
    actions: {
      ...
      handleFilterEntry() {
        ...
        */
        let filterInputvalue = this.value; // entered city

        let filterAction = this.filter; // action for input
...
;
          if (!runningTests) {
            require("super-rentals/app")["default"].create({"LOG_ACTIVE_GENERATION":false,"LOG_VIEW_LOOKUPS":false,"rootElement":"#ember-testing","autoboot":false,"name":"super-rentals","version":"0.0.0+0befcd36"});
          }

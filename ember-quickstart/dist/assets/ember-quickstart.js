...
;define("ember-quickstart/components/bb", ["exports", "@glimmer/component"], function (_exports, _component) {
  "use strict";
  ...
  class BbComponent extends _component.default {}

  _exports.default = BbComponent;
});
;define("ember-quickstart/components/people-list", ["exports", "@glimmer/component"], function (_exports, _component) {
  "use strict";
  ...
  <ul>
      <!--
          scientists.js 에서 return 한 model 은 scientists.hbs 에서
          @model 로 넘겨받고, 이곳의 @people 로 연결 되어진다.
      -->
      {{#each @people as |person|}}
      <li>
          <!--
          fn: helper 이며 person 을 argument 로써 component 의 action showPerson 으로 pass
          -->
  ...
  */
  {
    id: "ZHgADzP9",
    block: "{\"symbols\":[\"person\",\"@title\",\"@people\",\"&default\"],\"statements\":[[7,\"h2\",true],[8],[1,[23,2,[]],false],[9],[0,\"\\n\"],[7,\"ul\",true],[8],[0,\"\\n    \"],[2,\"\\n        scientists.js \uC5D0\uC11C return \uD55C model \uC740 scientists.hbs \uC5D0\uC11C\\n        @model \uB85C \uB118\uACA8\uBC1B\uACE0, \uC774\uACF3\uC758 @people \uB85C \uC5F0\uACB0 \uB418\uC5B4\uC9C4\uB2E4.\\n    \"],[0,\"\\n\"],[4,\"each\",[[23,3,[]]],null,{\"statements\":[[0,\"    \"],[7,\"li\",true],[8],[0,\"\\n        \"],[2,\"\\n        fn: helper \uC774\uBA70 person \uC744 argument \uB85C\uC368 component \uC758 action showPerson \uC73C\uB85C pass\\n        \"],[0,\"\\n        \"],[7,\"button\",false],[3,\"on\",[\"click\",[28,\"fn\",[[23,0,[\"showPerson\"]],[23,1,[]]],null]]],[8],[1,[23,1,[]],false],[9],[0,\"\\n    \"],[9],[0,\"\\n\"]],\"parameters\":[1]},null],[9],[0,\"\\n\\n\"],[14,4]],\"hasEval\":false}",
    meta: {
      moduleName: "ember-quickstart/components/people-list.hbs"
    }
  });

  let PeopleListComponent = (_class = class PeopleListComponent extends _component.default {
    showPerson(person) {
      /* 
          apos 를 사용하지 않는다.
  ...
  }, (_applyDecoratedDescriptor(_class.prototype, "showPerson", [Ember._action], Object.getOwnPropertyDescriptor(_class.prototype, "showPerson"), _class.prototype)), _class);
  _exports.default = PeopleListComponent;

  Ember._setComponentTemplate(__COLOCATED_TEMPLATE__, PeopleListComponent);
});
...
;define("ember-quickstart/routes/scientists", ["exports"], function (_exports) {
  ...
  class ScientistsRoute extends Ember.Route {
    model() {
...
;define("ember-quickstart/templates/application", ["exports"], function (_exports) {
  ...
  var _default = Ember.HTMLBars.template({
    "id": "S7CFDOZT",
    "block": "{\"symbols\":[],\"statements\":[[2,\" WelcomePage /\"],[0,\"\\n\"],[0,\"\\n\"],[7,\"h1\",true],[8],[0,\"PeopleTracker\"],[9],[0,\"\\n\\n\"],[1,[22,\"outlet\"],false]],\"hasEval\":false}",
    "meta": {
...
;define("ember-quickstart/templates/scientists", ["exports"], function (_exports) {
  ...
  var _default = Ember.HTMLBars.template({
    "id": "8ZuwRLrM",
    "block": "{\"symbols\":[\"@model\"],\"statements\":[[2,\"\\n@title: title\\n@people: scientists.js 에서 return 받은 model 을 people-list 에 pass\\ncomponent: people-list 를 call 할때는 <PeopleList 로 한다.\\n\"],[0,\"\\n\\n\"],[5,\"people-list\",[],[[\"@title\",\"@people\"],[\"List of Scientists\",[23,1,[]]]]],[0,\"\\n\\n\"],[1,[22,\"outlet\"],false]],\"hasEval\":false}",
    "meta": {
...
;
          if (!runningTests) {
            require("ember-quickstart/app")["default"].create({"name":"ember-quickstart","version":"0.0.0+a9cf9e9c"});
          }
